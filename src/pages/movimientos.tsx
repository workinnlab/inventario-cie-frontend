            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div className="flex items-center gap-3">
                    <select
                        ...
                        className="h-12 px-4 rounded-2xl bg-[#f1f4f5] dark:bg-[#292a69] text-sm font-medium dark:text-[#fdfdfd] focus:outline-none focus:ring-2 focus:ring-[#4f645b]/50 cursor-pointer appearance-none"
                    >
